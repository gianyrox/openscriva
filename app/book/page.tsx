  ...
  useEffect(function loadRepoTree() {
    ...
    fetch(
      ...
      .then(function handleData(data) {
        ...
        // Writing-room model: only files inside books/ or pages/ are ever
        // considered content. Everything else (CLAUDE.md, AGENTS.md,
        // .claude/**, fork source, ...) must be invisible here.
        const hasBookDir = files.some(function inBook(f: string) {
          return /^books\/[^/]+\/book\//.test(f) && f.endsWith(".md");
        });
    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            {onboardState === "has-markdown"
              ? "Select one of the pages or books below, or go back to create a new one."
              : "Go back to your shelf and create a new page or book."}
          </p>
        </div>
