  ...
  async function handleTestConnection() {
    ...
    try {
      ...
      if (res.ok && data.success) {
        ...
        // Persist the key immediately on successful validation so the user
        // never needs to re-enter it, even if they bail mid-wizard.
        try {
          const storeRes = await fetch("/api/keys/store", {
            method: "POST",
